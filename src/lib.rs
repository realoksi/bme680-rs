...
physical!( res_heat_5 i2c(0x5D) spi(0x5D, 1) );
physical!( res_heat_4 i2c(0x5C) spi(0x5C, 1) );
physical!( res_heat_3 i2c(0x5B) spi(0x5B, 1) );
physical!( res_heat_2 i2c(0x5A) spi(0x5A, 1) );
physical!( res_heat_1 i2c(0x59) spi(0x59, 1) );
physical!( res_heat_0 i2c(0x58) spi(0x58, 1) );
