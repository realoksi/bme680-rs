...
map!(res_heat_1, 0x5B);
map!(res_heat_0, 0x5A);
map!(idac_heat_9, 0x59);
map!(idac_heat_8, 0x58);
map!(idac_heat_7, 0x57);
map!(idac_heat_6, 0x56);
map!(idac_heat_5, 0x55);
map!(idac_heat_4, 0x54);
map!(idac_heat_3, 0x53);
map!(idac_heat_2, 0x52);
map!(idac_heat_1, 0x51);
map!(idac_heat_0, 0x50);
map!(gas_r_lsb_2, 0x4F);
map!(gas_r_msb_2, 0x4E);
map!(hum_lsb_2, 0x48);
map!(hum_msb_2, 0x47);
